...
#                id_idn1=including[i]
                ...
                if float(str(df.iloc[line]['depth']))>10:
                    ...
                    #print ('vessel number is '+vessel_number)
                    #print ('line is '+str(line) )
                    
                    #print ('date is '+str(datet) )
                    #print (df_tele_status['Boat'])
...
def main():
    ...
    #files=download_raw_file(ftppath='/Matdata',localpath=Rawf_path)# UPDATE THE RAW csv FILE
    print (files)
