...
def main():
    ...
    classify_by_boat(indir='E:\\programe\\raw_data_match\\result\\Matdata',outdir='E:\\programe\\raw_data_match\\result\\classified',pstatus=telemetry_status)
    print('classfy finished!')
    #check the reformat of every file:include header,heading,lat,lon,depth,temperature.
    check_reformat_data(indir='E:\\programe\\raw_data_match\\result\\classified',outdir='E:\\programe\\raw_data_match\\result\\checked',startt=start_time,\
